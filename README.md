...
3. Développe et teste (backend : `cargo build`, frontend : `npm run dev`)
4. Commit avec un message clair : `git commit -m "feat: description"`
5. Push et ouvre une Pull Request

Convention de commits : `feat:`, `fix:`, `docs:`, `style:`, `refactor:`, `chore:`.
